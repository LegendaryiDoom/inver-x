...
function init(){
    $("#btn").on("click", function()  {
        ...
        rfc:{minlength:"Campos insuficientes solo se aceptan 16 caracteres",maxlength:"Numero de campos exedido solo se aceptan 16 caracteres"},
